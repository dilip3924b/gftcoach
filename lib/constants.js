...
export const GOLDAPI_KEY = process.env.EXPO_PUBLIC_GOLDAPI_KEY || '';

export const TRADEABLE_SYMBOLS = ['EURUSD', 'XAUUSD', 'BTCUSD'];
...
export const ASSET_PROFILES = {
  ...
  XAUUSD: {
    ...
    lotSize: 0.01,
    pointValue: 0.01,
    bestTimeIST: '1:30 PM - 3:30 PM OR 6:30 PM - 10:30 PM',
    demoOnly: false,
  },
  BTCUSD: {
    symbol: 'BTC/USD',
    ...
    lotSize: 0.01,
    pointValue: 0.01,
    bestTimeIST: '6:30 PM - 3:30 AM',
    demoOnly: true,
    demoNote: 'Demo only unless your funded account supports BTCUSD CFD.',
  },
};
